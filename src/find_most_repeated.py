"""This function looks through a flat list and returns a dictionary
that describes the most repeated element(s) in the list."""
def find_most_repeated(elements):
    ...
    result["elements"] = sorted([key for key in elements_dict
                                 if elements_dict[key] == result["repeats"]])
    return result
